...
export default function PortfolioOne() {
  ...
  const projects = [
    {
      ...
      description:
        " Full-stack marketplace supporting instructor onboarding, course creation, assignments, quizzes,certificates, and course recommendations. Built scalable notification queues, bulk upload handling, and interactive dashboard",
    ...
    },
    {
      ...
      description:
        "Scalable video streaming backend supporting adaptive HLS encoding, playlists, likes, comments, and subscriptions. Built community feed APIs using aggregation pipelines for recommendations and pagination.",
      image: "https://res.cloudinary.com/dpsqzixmj/image/upload/v1765089485/Screenshot_2025-12-07_113612_qoy8ot.png",
      technologies: ["JavaScript", "Node.js", "Express.js", "MongoDB", "Cloudinary", "ffmpeg", "JWT", "Winston", "Morgan"],
    ...
    },
    {
      ...
      description:
        "An Ride booking and location tracking app similar to uber",
    ...
    },
    {
      ...
      image: "https://res.cloudinary.com/dpsqzixmj/image/upload/v1765104757/Screenshot_2025-12-07_155043_n4yqyw.png",
...

    {
      ...
      description:
        "An all in one android health Care app where you can book doctor's appointment,buy medicine,book tests,read health related articles,and track you orders",
    ...
    },
    {
      ...
      description:
        "Geometry wars game which reads config from file and draw entities from screen and also manage their physics engine",
  ...
  const skills = {
    frontend: [
      ...
      { name: "Next.js", level: 10, icon: "▲" },
      { name: "TypeScript", level: 88, icon: "📘" },
      { name: "Tailwind CSS", level: 8, icon: "🎨" },
      { name: "Vue.js", level: 0, icon: "💚" },
    ...
    tools: [
      ...
      { name: "AWS", level: 30, icon: "☁️" },
      { name: "Vercel", level: 40, icon: "▲" },
      { name: "Figma", level: 25, icon: "🎨" },
      { name: "VS Code", level: 78, icon: "💙" },
    ],
  }
          ...
          >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12 max-w-2xl mx-auto">
              <div className="text-center">
                ...
                <div className="text-neutral-400 text-sm">Months Experience</div>
              </div>
              <div className="text-center">
